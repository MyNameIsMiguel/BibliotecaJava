...
public class VistaModificaEmpregado extends JFrame implements InterfazModificaEmpregado{
	JTextField textoDni;
	...
	JButton eliminar;
	JButton modificar;
	public VistaModificaEmpregado(){
		this.setTitle("Modificar Empregados");
		...
		eliminar.setToolTipText("eliminar o empregado co dni indicado");
